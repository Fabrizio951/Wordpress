...
<section class="form-register">
    ...
    <!-- INICIO BOTON AUMENTAR/ DISMINUIR VALOR-->
    <div class="input-group">
      <button class="btn btn-outline-primary" onclick="decrementMonto()">-</button>
      <button class="btn btn-outline-primary" onclick="incrementMonto()">+</button>
    </div>
    <!--FINAL-->
